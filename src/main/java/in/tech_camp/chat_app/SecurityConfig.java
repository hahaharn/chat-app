...
// ユーザーの新規登録・ログイン・ログアウト・ログイン状態にあわせた表示制御の設定を行っている
// 新規登録画面のパス                         ：/users/sign_up
// 登録フォームから送られるリクエストのパス     ：/user
// ログイン画面のパス                         ：/users/login
// ログインフォームから送られるリクエストのパス ：/login
// ログアウトボタンを押した時のリクエストのパス ：/logout
